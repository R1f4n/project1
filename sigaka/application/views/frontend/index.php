...
<head>
	...
	<!-- favicons
    ================================================== -->
	<link rel="shortcut icon" href="<?= base_url() ?>assets/images/logo/logode.jpg" type="image/x-icon">
	<link rel="icon" href="<?= base_url() ?>assets/images/logo/logode.jpg" type="image/x-icon">
...
================================================== -->
	...
	<!-- home
================================================== -->
	<section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="<?= base_url() ?>assets/frontend/images/sigaka/Dapur emma.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
		...
		<div class="home-content">
			...
			<div class="row home-content__main">
				...
				<p>
				provides a variety of food and pastries
                </p>
			...
			<div class="col-full">
				...
				<div class="slideshow-container">
					...
					<div class="mySlides fade" style="width: 100%">
						...
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/asset DC1.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>Kue Katumbiri</b>Kue geulis warna-warni katumbiri nu lumer di mulut</div>
					</div>

					<div class="mySlides fade" style="width: 100%">
						<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">2 / 10</div>
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/foto qori.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>qori uhammad al-amin</b>, Jalan Suka Karya, Kecamatan Tampan</div>
					</div>
	...
	<section id="contact" class="s-contact">
		...
		<div class="row">
			...
			<div class="col-full contact-main" data-aos="fade-up">
				<p>
					<a href="mailto:#0" class="contact-email">syahr9610@gmail.com</a>
					<a href="mailto:#0" class="contact-email">putrimgustiani@gmail.com</a>
					<span class="contact-number">+6289696120616</span>
					<span class="contact-number">+62895334837995</span>
				</p>
		...
		<div class="row">
			...
			<div class="col-five tab-full contact-secondary" data-aos="fade-up">
				...
				<p class="contact-address">
					Jalan pasir koja, Rt01 r04<br>
					Kecamatan Babakan  Ciparay , kelurahan Suka Haji, Bandung, Jawa Barat<br>
				</p>
		...
		<div class="row">
			<div class="col-full cl-copyright">
				<span>
					...
					</script> All rights reserved | <a href="http://wikidevia.digtive.id/" target="_blank">Commer</a> | Repost by <a href="https://instagram.com/rfannsyahhhhhhhh?igshid=ZDdkNTZiNTM=" title="instagram.com" target="_blank">Rifansyah Hidayatulloh</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</span>
			</div>
</div>
